...
fig.suptitle( "\nSimPL\n\nAverage fitness over 100 generations.", fontsize = 18, family = "serif" );
ax = fig.gca( projection = "3d" );

cc = lambda arg: colorConverter.to_rgba( arg, alpha = 0.8 );

csv_file = open( "SIMPL_EXP_AVGS_all.csv", "r" );
...
ax.set_ylim3d( 1, 7 );
ax.set_zticks( np.arange( 0, 3501, 500 ) );
ax.set_zlabel( "Average Fitness", family = "serif" );
