...
fig.suptitle( "\nSimPL\n\nAverage ball-in-play time of five rounds per every 10th generation top performer.", fontsize = 18, family = "serif" );
ax = fig.gca( projection = "3d" );

cc = lambda arg: colorConverter.to_rgba( arg, alpha = 0.8 );

csv_file = open( "SIMPL_EXP_TOUR_RSLTS_all.csv", "r" );
...
ax.set_ylim3d( 1, 7 );
ax.set_zticks( np.arange( 0, 48.5, 2.5 ) );
ax.set_zlabel( "Average Ball-in-play Time (Seconds)", family = "serif" );
ax.set_zlim3d( 0, 47.5 );
